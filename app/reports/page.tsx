...
export default function ReportsPage() {
  ...
  const exportPDF = () => {
    ...
    doc.text('Memon Welfare - Karachi Chapter', 105, 15, { align: 'center' });
      ...
      <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div className="report-header" style={{
          ...
          <div>
            ...
            <p style={{ fontSize: '0.85rem', color: 'var(--gray-text)' }}>Memon Welfare - Karachi Chapter</p>
          </div>
